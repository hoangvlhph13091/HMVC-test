        ...
        <form id="AreaForm">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input class="form-control" id="book_area_name" name="book_area_name" type="text"
                        placeholder="Tên Khu Vực">
                    <span class="text-red-600 err_text" id="book_area_name_err"></span>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Ghi Chú</label>
                    <textarea id="book_area_note" name="book_area_note" rows="3" class="form-control" placeholder="Ghi Chú"></textarea>
                </div>
            </div>
            <!-- /.card-body -->
