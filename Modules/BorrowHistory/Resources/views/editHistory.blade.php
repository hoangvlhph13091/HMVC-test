    ...
    <div class="card card-primary">
        ...
        <form id="historyFrom">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control"  id="reader_name" name="reader_name" disabled type="text" placeholder="Tên Bạn Đọc" value="{{ $history->reader_name }}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="reader_id" name="reader_id" disabled type="text" placeholder="id" value="{{ $history->reader_id }}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <Select class="form-control" name="reader_status" id="reader_status" disabled>
                                <Option @if ($history->reader_status == 1) selected @endif class="reder_register" id="reader_registed" value="1">Đã Đăng Ký</Option>
                                <Option @if ($history->reader_status == 0) selected @endif class="reder_register" id="reader_not_resgisterd" value="0">Chưa Đăng Ký
                                </Option>
                            </Select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="reader_address" disabled name="reader_address" type="text" placeholder="Địa Chỉ" value="{{ $history->reader_address }}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="reader_tel" disabled name="reader_phone" type="text" placeholder="Số Điện Thoại" value="{{ $history->reader_phone }}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="reader_fee" name="reader_fee" type="number"
                                placeholder="Phí Mượn Sách" value="{{ $history->reader_fee }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="borrow_date" data-target-input="nearest">
                                <input type="text" name="borrow_date" id="borrow_date_input" class="form-control datetimepicker-input"
                                    data-target="#borrow_date" value="{{ $history->borrow_date }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="return_date" data-target-input="nearest">
                                <input type="text" name="return_date" id="return_date_input" class="form-control datetimepicker-input"
                                    data-target="#return_date" value="{{ $history->return_date }}" />
                ...
                <input type="hidden" id="book_count_number" value="{{ $count }}">
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            var counter = $('#book_count_number').val() ;

            for (let index = 0; index < counter; index++) {
                $('#select_book_'+index).select2();
            }
