                    ...
                    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" id="UserForm" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="name" name="name" type="text" placeholder="Tên Thành Viên">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="password" name="password" type="password" placeholder="Mật Khẩu">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="confirm_password" name="confirm_password" type="password" placeholder="Xác Nhận Mật Khẩu">
