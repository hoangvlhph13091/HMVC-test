            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select id="sex" name="sex" class="form-control">
                        <option {{ $cust->sex == 0 ? 'selected' : '' }} value="0">Nữ</option>
                        <option {{ $cust->sex == 1 ? 'selected' : '' }} value="1">Nam</option>
                    </select>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="input-group date" id="date_of_birth" data-target-input="nearest">
                                <input type="text" name="date_of_birth" id="date_of_birth_input"
                                    value="{{ $cust->date_of_birth }}" class="form-control datetimepicker-input"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address" value="{{ $cust->address }}" name="address"
                        type="text" placeholder="Địa Chỉ">
                    <span class="text-red-600 err_text" id="address_err"></span>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1"> Số Điện Thoại</label>
                    <input type="text" class="form-control" value="{{ $cust->phone_number }}" id="phone_number"
...
@section('scripts')
    <script>
        let dob_input = $('#date_of_birth_input').val()
