                ...
                <div class="p-6 text-gray-900">
                    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" id="BookForm" method="POST">
                        ...
                        <div class="mb-6">
                          ...
                          name="overview"
                          rows="3"
                          class="mt-1 block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6" placeholder="insert content here">{{ $book->overview }}</textarea>
                        </div>
